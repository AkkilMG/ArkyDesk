...
//     html = html.replace(/{{body}}/g, "Thank you for signing up for Arkynox Support. To complete your registration and verify your email address, please click on the link below:");
...
//                                       </p>`);
//     var emailer = await sendEmail(to, "Verify Your Email Address for Arkynox Support", html);
//     return emailer;
//   } catch (error) {
...
//     html = html.replace(/{{name}}/g, name);
//     html = html.replace(/{{body}}/g, "Thank you for signing up for Arkynox Support. To complete your chnage your password and verify your email address, please click on the link below:");
//     html = html.replace(/{{extra}}/g, `<p style="font-size: 15px; line-height: 24px; margin: 16px 0; margin-bottom: 20px; margin-top: 20px; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; text-align: left;">
